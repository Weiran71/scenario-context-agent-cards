...
\begin{tikzpicture}[
  ...
  out/.style={draw=navy!70,rounded corners=2pt,fill=green,align=center,minimum height=8mm,text width=28mm,font=\small},
...
\node[out,below left=of dec] (silent) {No card\\reason};
\node[out,below right=of dec] (gen) {Card generation\\copy, action, POI, icon};
\node[out,below=of gen] (eval) {Validation and rubric evaluation};
